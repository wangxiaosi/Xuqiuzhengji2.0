...
div{
  ...
  <td colspan="4">
   <span id="RadioGroup2_1">
        <input type="radio" name="shenhebm" value="1"  onclick="jichu()" id="shenhebm1" checked/>通过</span></label>
        <span id="RadioGroup2_2">
        <input type="radio" name="shenhebm" value="2" onclick="feijichu()" id="shenhebm2" />不通过</span>
  </td>  
  </tr>
  <tr id="yijian"  style="display:none">
  <td colspan="1"><b>审核意见</b></td>
  <td colspan="4">
  <textarea type="text" name="bmshenheyijian" id="bmshenheyijian" style="width:760px;height:70px"required></textarea>
  </td>  
  </tr>
  <tr>
  <td colspan="5">
